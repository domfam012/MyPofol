  ...
  return (
    <div className="contents">
      ...
      <div className="btn-area mb">
        ...
        <button onClick={updateCategory} className="btn btn-lg btn-primary">
          저장
        </button>
      </div>
    </div>
...
const AddCategory = props => {
  ...
  const registerCategory = async () => {
    ...
    const storageRef = storage.ref(
      `site/${props.site}/category/${categoryKey}`
    );
    const uploadTask = storageRef.put(img);
  ...
  return (
    <div className="contents">
      ...
      <div className="btn-area mb">
        ...
        <button onClick={registerCategory} className="btn btn-lg btn-primary">
          저장
        </button>
      </div>
    </div>
...
const Category = props => {
  ...
  useEffect(() => {
    siteInfo.categoryList.length === 0
      ? dispatch({ type: CATEGORY_STATE, data: { state: "none" } })
      : dispatch({ type: CATEGORY_STATE, data: { state: "unselected" } });
  }, []);
